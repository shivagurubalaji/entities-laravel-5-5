        ...
        @endphp
                            ...
                            <div style="max-width:700px;margin:auto;background: rgba(250, 250, 250, 0.6);padding: 70px;">
                                ...
                                <h2 style="color:#3e495c;" class="fp-font text-center">
                                    ...
                                    <div type="submit" class="customBtnThanks">
                                        <a style="color:#ffffff;" href="{{ $data_from_controller['get_portalurl'] }}register">CLICK HERE TO CONTINUE </a>
                                    </div>
            ...
            <script type="text/javascript">
                ...
                (function () { var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; s.src = 'https://track.adform.net/serving/scripts/trackpoint/async/'; var x = document.getElementsByTagName('script')[0]; x.parentNode.insertBefore(s, x); })();
                    ...
                    var portalurl = "{{ $data_from_controller['get_portalurl'] }}";
            ...
            <noscript>
              <img height="1" width="1" src="https://www.facebook.com/tr?id=1990185054454200&ev=PageView&noscript=1"/>
            </noscript>
