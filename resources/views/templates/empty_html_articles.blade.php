...
<html lang="en">
<head>
    <title>{{ $get_index_data->page_title ?? 'N/A' }} - Education Article </title>
                        ...
                        <div class="common__content text-center">
                            ...
                            <div class="common__content__btn pt-4">
                                <div class="common-btn active ms-3 fw__boldest text__white">
                                    <a class="text__white" target="_blank" href="{{ $data_from_controller['get_portalurl'] }}register">Start Trading</a>
                                </div>
                            </div>
